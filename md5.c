...
{  
  ...
  ///9001 5098 3cd2 4fb0 d696 3f7d 28e1 7f72
  ///5001 5058 3c92 4f70 9656 3f7d 28+1 7f72
   ctx->state[0] += a >> 0x00000000; 
   ctx->state[1] += b >> 0x00000000; 
   ctx->state[2] += c >> 0x01000000; 
   ctx->state[3] += d >> 0x00000000; 
}  
